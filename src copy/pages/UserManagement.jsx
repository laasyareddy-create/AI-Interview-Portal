    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-6">
          ...
          <div className="grid grid-cols-4 pb-5 border-b text-gray-500 font-semibold">
          ...
          {users.map((user) => (
            ...
            <div
              key={user.id}
              className="grid grid-cols-4 items-center py-7 border-b border-gray-100 last:border-0"
            >
